...
export class BalancerPool__getMiscDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BalancerPool__getPastAccumulatorsInputQueriesStruct extends ethereum.Tuple {
  get variable(): i32 {
    return this[0].toI32();
  }
...
export class BalancerPool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class BalancerPool__getSampleResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BalancerPool__getTimeWeightedAverageInputQueriesStruct extends ethereum.Tuple {
  get variable(): i32 {
    return this[0].toI32();
  }
...
export class BalancerPool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class BalancerPool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class BalancerPool__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class BalancerPool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class BalancerPool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class BalancerPool extends ethereum.SmartContract {
  static bind(address: Address): BalancerPool {
    return new BalancerPool("BalancerPool", address);
  }
  ...
  getMiscData(): BalancerPool__getMiscDataResult {
    let result = super.call(
      "getMiscData",
    ...
    return new BalancerPool__getMiscDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getMiscData(): ethereum.CallResult<BalancerPool__getMiscDataResult> {
    let result = super.tryCall(
      "getMiscData",
      "getMiscData():(int256,int256,uint256,uint256,bool,uint256)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new BalancerPool__getMiscDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getPastAccumulators(
    queries: Array<BalancerPool__getPastAccumulatorsInputQueriesStruct>
  ): Array<BigInt> {
    let result = super.call(
      "getPastAccumulators",
  ...
  getPausedState(): BalancerPool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new BalancerPool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getPausedState(): ethereum.CallResult<
    BalancerPool__getPausedStateResult
  > {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BalancerPool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getSample(index: BigInt): BalancerPool__getSampleResult {
    let result = super.call(
      "getSample",
    ...
    return new BalancerPool__getSampleResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getSample(
    index: BigInt
  ): ethereum.CallResult<BalancerPool__getSampleResult> {
    let result = super.tryCall(
      "getSample",
      "getSample(uint256):(int256,int256,int256,int256,int256,int256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(index)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BalancerPool__getSampleResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getTimeWeightedAverage(
    queries: Array<BalancerPool__getTimeWeightedAverageInputQueriesStruct>
  ): Array<BigInt> {
    let result = super.call(
      "getTimeWeightedAverage",
  ...
  onExitPool(
    ...
    userData: Bytes
  ): BalancerPool__onExitPoolResult {
    let result = super.call(
      "onExitPool",
    ...
    return new BalancerPool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<BalancerPool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BalancerPool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): BalancerPool__onJoinPoolResult {
    let result = super.call(
      "onJoinPool",
    ...
    return new BalancerPool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<BalancerPool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BalancerPool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray()
      )
    );
  ...
  onSwap(
    request: BalancerPool__onSwapInputRequestStruct,
  ...
  queryExit(
    ...
    return new BalancerPool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<BalancerPool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BalancerPool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray()
      )
    );
  ...
  queryJoin(
    ...
    return new BalancerPool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<BalancerPool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BalancerPool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray()
      )
    );
